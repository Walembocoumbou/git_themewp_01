...
function betoba_theme_stylesheets() {
    // Déclarer jQuery
    wp_enqueue_script('jquery' );
    // Déclarer style.css à la racine du thème
    wp_enqueue_style( 'betoba-wafers-style', get_stylesheet_uri(), '', null, 'all', '1.0'  );
    // Déclarer les autres fichiers CSS
    wp_enqueue_style( 'betoba-wafers-main',  get_template_directory_uri() .'/css/main.css', array(), null, 'all', '1.0'  );
    wp_enqueue_style( 'betoba-wafers-normalize',  get_template_directory_uri() .'/css/normalize.css', array(), null, 'all', '1.0' );
}
add_action( 'wp_enqueue_scripts', 'betoba_theme_stylesheets' );
